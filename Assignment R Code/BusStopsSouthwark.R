...
BusStops <- geojson_read("/Users/jasondalrymple/Desktop/UCL laptop  LBU 19_9_26/A. Modules/CASA0005 GIS&S/RCodeForAssignment/CodeForBusses/bus routes/BusStopGeoJsonFile.geojson", 
                          what = "sp")
# code is available from the following site # code is available from the following site https://github.com/jasdalucl2018/CASA_Assignment_2019/blob/master/geojson%20files%20/BusStopGeoJsonFile.geojson
#6. Run summary data
summary(BusStops)
